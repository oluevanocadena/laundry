...
export const validators = {
  ...
  Time: [
    Validators.required,
    Validators.pattern('^(1[0-2]|0?[1-9]):[0-5][0-9] (AM|PM|am|pm)$'),
  ],
  Price: [
    Validators.required,
    Validators.pattern(
      '^([0-9]*[1-9][0-9]*(.[0-9]{1,2}))$|^([0-9]*[0-9][0-9]*(.[0-9]{1,2}))$|^[1-9][0-9]*$'
    ),
  ],
  PriceFourDecimal: [
    Validators.required,
    Validators.pattern(
      '^([0-9]*[1-9][0-9]*(.[0-9]{1,4}))$|^([0-9]*[0-9][0-9]*(.[0-9]{1,4}))$|^[1-9][0-9]*$'
    ),
  ],
  PriceZero: [
    Validators.required,
    Validators.pattern('^(?=1*[0-9])[0-9]*[.,]?[0-9]{1,2}$'),
  ],
  Percentage: [
    Validators.required,
    Validators.pattern('^([1-9]|([1-9][0-9])|100)$'),
  ],
  ...
  SATRfc: [
    Validators.required,
    Validators.pattern(
      '^([a-zA-ZÑ&]{3,4})?(?:-?)?(\\d{2}(?:0[1-9]|1[0-2])(?:0[1-9]|[12]\\d|3[01]))?(?:-?)?([a-zA-Z\\d]{2})([A\\d])$'
    ),
  ],
  Curp: [
    Validators.required,
    Validators.pattern(
      '^[A-Za-z]{4}[0-9]{6}[HMhm]{1}[A-Za-z]{2}[BCDFGHJKLMNPQRSTVWXYZbcdfghjklmnpqrstvwxyz]{3}([A-Za-z]{2})?([0-9]{2})?$'
    ),
  ],
  NSS: [
    Validators.required,
